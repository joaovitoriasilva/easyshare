...
def get_service_settings(admin: AdminUser) -> ServiceSettingsRead:
    ...
    return ServiceSettingsRead(
        ...
        share_verification_code_ttl_minutes=settings.share_verification_code_ttl_minutes,
        share_verification_max_attempts=settings.share_verification_max_attempts,
